...
plt.rcParams['font.sans-serif'] = ['Arial', 'Tahoma', 'DejaVu Sans', 'Verdana']
plt.rcParams['axes.unicode_minus'] = False # Hiển thị đúng dấu trừ nếu có
...
# Kết nối các điểm tạo đường zigzag
...
# Ghi nhãn tất cả các năm (Ghi đè font cho text)
for y, val in all_pts:
    plt.text(y, val + 0.1, str(y), fontsize=9, ha='center', rotation=45, fontweight='bold')

# Định dạng biểu đồ
plt.title("SƠ ĐỒ CHU KỲ BENNER TOÀN DIỆN (1900 - 2059)", fontsize=20, pad=30, fontweight='bold')
